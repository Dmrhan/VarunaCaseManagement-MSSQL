...
// WR-ACTION-CENTER Phase 1 — operator-facing topic. Mounted from the
// Eylem Merkezi drawer header; explains the bell, counters, item kinds,
// row actions, and how it differs from the right-side bahsetme zili.
HELP_TOPICS.push({
  topic: 'action-center',
  audience: 'operator',
  title: 'Eylem Merkezi — Operatör Rehberi',
  summary:
    'Üst menüdeki Eylem Merkezi zili senden somut aksiyon bekleyen iş satırlarını ve seninle ilgili bilgilendirmeleri tek yerde toplar. Sağdaki bahsetme zili (eski bildirimler) yerine geçmez — ikisi yan yana çalışır.',
  ...
  sections: [
    {
      title: 'Eylem Merkezi nedir?',
      body: [
        'Üst çubuktaki ListChecks ikonu (kırmızı + gri sayaçlı) Eylem Merkezi zilidir. Tıklayınca sağdan açılan panelde senin için açık iş satırları listelenir.',
        'Bir satırın orada görünüyor olması demek: ya senden bir karar bekleniyor (örn. çözüm onayı) ya da seninle ilgili bir bilgilendirme yapılmış (örn. gönderdiğin onayın sonuçlandığı).',
      ],
    },
    {
      title: 'İki sayaç: Eylem Bekleyen ve Bildirimler (FYI)',
      body: [
        'Kırmızı sayaç — Eylem Bekleyen: senden somut bir aksiyon isteniyor (Onayla, Reddet, revize et).',
        'Gri sayaç — Bildirimler (FYI): aksiyon zorunlu değil, sadece haberin olsun diye gelir (örn. gönderdiğin onay sonuçlandı).',
        'Drawer içindeki sekmeler de aynı ayrımı yapar: "Eylem Bekleyen" / "Bildirimler" / "Ertelenen" / "Yapıldı".',
      ],
    },
    {
      title: 'Hangi tür satırları görürsün?',
      body: [
        '"approval_pending" — Bir vakanın çözüm onayı sana yönlendirildi. Satırın üzerinde Onayla / Reddet butonları çıkar.',
        '"approval_decided" — Senin gönderdiğin bir çözüm onayı sonuçlandı (kabul veya red). Aksiyon zorunlu değil; sonucu okuyup "Okundu" diyerek arşivleyebilirsin.',
        '"case_returned_to_assignee" — Çözüm önerin reddedildi ve vakayı revize edip yeniden göndermen bekleniyor. Vakayı aç, düzelt, tekrar çözüm onayına gönder; sonra satırı "Tamamlandı" ile kapat.',
      ],
    },
    {
      title: 'Bir satırda hangi eylemleri yapabilirsin?',
      body: [
        '"Vakayı Aç" — Vaka detayına geçer; satır otomatik olarak "çalışıyor" durumuna döner ve diğer kullanıcılar üzerine geldiğini görür.',
        '"Onayla" / "Reddet" — Sadece sana düşen çözüm onayı satırlarında görünür. Mevcut onay endpointleri çağrılır; yeni bir karar yolu açılmaz.',
        '"Tamamlandı" / "Okundu" — İşin sende bitti, satır arşivlenir (state = Done).',
        '"Ertele" — Bir saat / yarın 09:00 / pazartesi 09:00 gibi presetlerle satırı geçici olarak gizler; vakti gelince otomatik geri döner.',
        '"Yok Say" — Sana düşmediğini düşündüğün satırı opsiyonel bir not bırakarak kapatır (state = Dismissed).',
      ],
    },
    {
      title: 'Bir satır niçin senin önünde çıktı?',
      body: [
        'Her satırın altında küçük bir "neden" cümlesi vardır — boş bırakılmaz. Tipik nedenler:',
        '• Çözüm onayı politikasının onaylayıcı kapsamında olman (Takım Lideri, Süpervizör, Admin rolü gibi).',
        '• Vakanın halen sana atanmış olması (örn. çözüm önerin reddedildiyse).',
        '• Sen göndericisi olduğun bir çözüm onayının sonuçlanması (bilgilendirme).',
      ],
    },
    {
      title: 'Eski bahsetme zili ile farkı',
      body: [
        'Sağdaki çan ikonu (bahsetme zili) hâlâ vaka yorumlarında geçen @bahsetmeleri ve eski bildirim akışını gösterir.',
        'Eylem Merkezi (soldaki yeni ikon) yalnızca somut aksiyon ve karar satırlarını gösterir; bahsetmeleri taşımaz.',
        'İki zil birbirini tekrar etmez; aynı anda görünür ve birlikte çalışırlar. Eski zilin davranışı değişmedi.',
      ],
    },
  ],
});
