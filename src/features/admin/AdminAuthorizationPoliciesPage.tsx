...
> = {
  ...
  securityFilter: {
    label: 'Pilot',
    tint: 'violet',
    description: 'Güvenlik filtresi kuralları vaka listesi/KPI, müşteri geçmişi-açık vaka yardımcı listeleri, tekil vaka okuma/yazma ve vaka detay yardımcı uçlarında AUTHORIZATION_SECURITY_FILTER_ENFORCEMENT_ENABLED=true iken kayıt kapsamını daraltan pilot filtre olarak çalışır.',
  },
};
