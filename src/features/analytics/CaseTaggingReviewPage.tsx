  ...
  return (
    <div className="flex h-full flex-col gap-3 p-4">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto overflow-x-hidden rounded-md border border-slate-200 dark:border-ndark-border">
        {/* Başlık */}
        <div className="sticky top-0 z-10 grid grid-cols-[2fr_90px_110px_1.5fr_1.2fr_2fr_2fr_160px_80px] border-b border-slate-200 bg-slate-50 dark:border-ndark-border dark:bg-ndark-card">
