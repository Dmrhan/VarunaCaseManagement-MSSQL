...
export const MOCK_SLA_POLICIES: SlaPolicy[] = [
  ...
  { id: 'SLA-001', companyId: 'COMP-PARAM',    companyName: 'PARAM',   productGroup: 'Sanal POS',          categoryName: 'Yazılım', subCategoryName: 'Performans',    requestType: 'Hata',     priority: null, responseHours: 1,  resolutionHours: 4,  description: 'Kritik ödeme akışı — yüksek öncelik',         isActive: true },
  { id: 'SLA-002', companyId: 'COMP-PARAM',    companyName: 'PARAM',   productGroup: 'Sanal POS',          categoryName: 'Yazılım', subCategoryName: 'Performans',    requestType: 'Şikayet',  priority: null, responseHours: 6,  resolutionHours: 12, description: 'Performans şikayetleri — orta öncelik',       isActive: true },
  { id: 'SLA-003', companyId: 'COMP-PARAM',    companyName: 'PARAM',   productGroup: 'Sanal POS',          categoryName: 'Yazılım', subCategoryName: 'Performans',    requestType: 'Bilgi',    priority: null, responseHours: 2,  resolutionHours: 8,                                                                isActive: true },
  { id: 'SLA-004', companyId: 'COMP-PARAM',    companyName: 'PARAM',   productGroup: 'Fiziki POS',         categoryName: 'Yazılım', subCategoryName: 'Entegrasyon',   requestType: 'Talep',    priority: null, responseHours: 12, resolutionHours: 48, description: 'Fiziki POS başvuru — Jira üzerinden ilerler',  isActive: true },
  { id: 'SLA-005', companyId: 'COMP-PARAM',    companyName: 'PARAM',   productGroup: '3D Secure Servisi',  categoryName: 'Yazılım', subCategoryName: 'Entegrasyon',   requestType: 'Hata',     priority: null, responseHours: 1,  resolutionHours: 6,  description: '3DS hataları — ödeme reddi etkisi',            isActive: true },
  // UNIVERA / FINROTA — ERP / CRM odaklı
  { id: 'SLA-006', companyId: 'COMP-UNIVERA',  companyName: 'UNIVERA', productGroup: 'ERP - Stok',         categoryName: 'Yazılım', subCategoryName: 'Raporlama',     requestType: 'Hata',     priority: null, responseHours: 4,  resolutionHours: 24, description: 'Stok raporu hataları — operasyonu etkiler',    isActive: true },
  { id: 'SLA-007', companyId: 'COMP-UNIVERA',  companyName: 'UNIVERA', productGroup: 'CRM Satış',          categoryName: 'Yazılım', subCategoryName: 'Mobil',         requestType: 'Talep',    priority: null, responseHours: 12, resolutionHours: 72,                                                                isActive: true },
  { id: 'SLA-008', companyId: 'COMP-FINROTA',  companyName: 'FINROTA', productGroup: 'ERP - Finans',       categoryName: 'Finans',  subCategoryName: 'Faturalama',    requestType: 'Hata',     priority: null, responseHours: 2,  resolutionHours: 8,  description: 'Faturalama hatası — finansal etki',            isActive: true },
  { id: 'SLA-009', companyId: 'COMP-FINROTA',  companyName: 'FINROTA', productGroup: 'ERP - Finans',       categoryName: 'Finans',  subCategoryName: 'Tahsilat',      requestType: 'Şikayet',  priority: null, responseHours: 4,  resolutionHours: 24,                                                                isActive: true },
  // Pasif örnek
  { id: 'SLA-010', companyId: 'COMP-PARAM',    companyName: 'PARAM',   productGroup: 'PayByLink',          categoryName: 'Yazılım', subCategoryName: 'Performans',    requestType: 'Öneri',    priority: null, responseHours: 24, resolutionHours: 168, description: 'Eski politika — yeni sürümle değiştirildi',  isActive: false },
];
