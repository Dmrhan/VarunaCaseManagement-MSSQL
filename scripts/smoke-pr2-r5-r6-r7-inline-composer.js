...
expectTrue('4.1 R14.2: Reader body max-w-[760px] mx-auto padding mode-aware (fs p-6 / inline p-4)',
  /flex-1 overflow-auto \$\{mode === 'fullscreen' \? 'p-6' : 'p-4'\}[\s\S]{0,200}mx-auto max-w-\[760px\]/.test(reader));
