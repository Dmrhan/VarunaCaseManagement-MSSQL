...
- Shipped: **10** — G1 (ongoing seed maintenance), A1 (commit `e6df055`, PR #150), H1 (commit `563e52d`, PR #151), H2 (commit `5780790`, PR #152 + `fb6ae7c` recovery PR #153), G5 (commit `278da6c`, PR #154 + `ed05424` fixup PR #155), C1 (commit `3bbf094`, PR #156 + `6f8afd6` fixup PR #157), F7 (commit `0b18516`, PR #158), A2 (commit `a22ddf1`, PR #159), A4 (Phase 1) (commit `82dc72c` + `f7c5054` fixup, PR #160; review fix `c948bbc` PR #162), A3 (commit `d995b3c`, PR #165)
- Ready: **12** — A5 (Phase 1), A6, A7 (A6 sonrası), A8 (Phase 1), B1 (Phase 1), C2, C3, F2, F3, F4, F5, G4
